...
local opts = {
    properties = "volume,sub-scale,video-zoom,video-pan,window-scale,speed,sub-delay,osd-width,osd-height,video-pan-x,video-pan-y,hflip,vflip,video-rotate,vf",
}
